...
public class DocubaseServiceImpl implements DocubaseService {

    private RestTemplate restTemplate;
    private DocubaseProperties docubaseProperties;

    public DocubaseServiceImpl(DocubaseProperties docubaseProperties) {
    ...
    public ResponseEntity<GetDocumentResponse> getDocumentByGedId(String domainId, String baseId, String gedId) {
        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(docubaseProperties.getUrl())
                .path(docubaseProperties.getUrlUserSession())
